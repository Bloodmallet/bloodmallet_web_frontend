...
function add_bloodmallet_trees() {
    ...
    for (let tree of tree_divs) {
        ...
        soon_to_be_loaded.then(data => {
            ...
            form_row.classList.add("bloodmallet-import-export-row");
            ...
            export_button.appendChild(document.createTextNode("Copy"));
            ...
            import_text_area.classList.add("form-control", "col", "bloodmallet-paste");
            import_text_area.placeholder = "Paste";
